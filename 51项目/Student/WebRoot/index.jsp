...
<html>
  ...
  <body>
    <form action="javasrcipt:void(0)">
                <div>
                    <label >用户名：</label>
                    <input id="user" type="text" class="l_user" name="name" placeholder="请输入用户名" required/>
                </div>
                <div >
                    <label >密码：</label>
                ...
                <div >
                   ...
                   <button type="button" class="layui-btn layui-btn-normal" value="登陆" id="log_btn">登陆</button>
                </div>
