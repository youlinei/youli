layui.extend({
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'money', title: '部门', Width:100, align:"center"},
  ...
  //工具栏事件
    ...
    function upUser(userid){
    	...
    	layui.layer.open({
    		title : "修改用户信息",
    		type : 2,
    		content : "/layuikaoshi/jsp/gonzi/gongziupdate.jsp",
    		area:['400px','540px'],
    		success:function(layero, index){
    			$.ajax({
    				url:"/layuikaoshi/news?action=gonzixiugaichaxun",
    				type:"post",
    				data:{"userid":userid},
    				success:function(data){
     			       ...
     			       body.find("#money").val(info.data.money);
  ...
  function deddddlUser(userid){
  	...
  	$.ajax({
  		url:"/layuikaoshi/news?action=gongzidel",
  		data:{"userid":userid},
  		type:"post",
  		success:function(data){
  			if(data == 1){
...
/*    //分配角色
  ...
  function addUser(){
  	layui.layer.open({
  		title : "添加用户",
  		type : 2,
  		content : "/layuikaoshi/jsp/gonzi/gongziadd.jsp",
  		area:['400px','490px'],
  	})
  }
