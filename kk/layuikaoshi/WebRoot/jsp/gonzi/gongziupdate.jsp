...
<form class="layui-form layui-form-pane" action="Javascript:void(0)">
 ...
 <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="mid" id="mid" lay-verify="required" placeholder="请输入登录名" autocomplete="off" class="layui-input">
    </div>
  </div>
...
<script type="text/javascript" src="${ctx}/jss/gongziupdate.js"></script>
</body>
</html>